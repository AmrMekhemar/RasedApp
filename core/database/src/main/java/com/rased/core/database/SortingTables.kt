...
data class IndexedWalletRow(val revision: String, val normalized: String, val sequence: Long, val walletType: String?, val location: String? = null, val walletModel: String? = null, val note: String? = null, val district: String? = null)
